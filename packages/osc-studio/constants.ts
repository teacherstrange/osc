...
export const COLOR_NAMES_MAP: {
    ...
    'gradient-primary': 'Dark Pink - Orange',
    'gradient-primary-90': 'Orange - Dark Pink (90deg)',
    'gradient-primary-180': 'Orange - Dark Pink',
    'gradient-primary-270': 'Dark Pink - Orange (90deg)',
