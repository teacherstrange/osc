...
describe('copy button', () => {
    test('adds text to the clipboard', async () => {
        render(
            <Button action="copy" textToCopy="Copy me!">
                Test Button
            </Button>
        );
    ...
    test('can be disabled', () => {
        render(
            <Button action="copy" textToCopy="Copy me!" isDisabled={true}>
                Can't click me!
            </Button>
        );
...
describe('anchor button', () => {
    test('has a href attribute', () => {
        render(
            <Button action="anchor" href="https://example.com">
                Test Button
            </Button>
        );
    ...
    test('sets the rel to noopener and noreferrer when target is "_blank"', () => {
        render(
            <Button action="anchor" href="https://example.com" target="_blank">
                Test Button
            </Button>
        );
