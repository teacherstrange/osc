...
* adds playwright to dev deps list ([6c9a4a3](https://github.com/Open-Study-College/osc/commit/6c9a4a3d722711dd474b0e070c3c0996f5b23a6f))
* adds step to install playwright browsers ([3caf4e8](https://github.com/Open-Study-College/osc/commit/3caf4e8e517ce5819e2a22b831617aa251419d56))
* attempt to run playwright using run rather than uses ([489c0af](https://github.com/Open-Study-College/osc/commit/489c0affe28f2315ce648b8bf6b891e82fc5d412))
* removes 'with' command ([40ffe83](https://github.com/Open-Study-College/osc/commit/40ffe83be53edf56b7ea27f36bfa19dba2402f9d))
* removes cypress from dev deps list ([fa2911d](https://github.com/Open-Study-College/osc/commit/fa2911d117b27d794fd588007234af33c6ca23d3))


### 📦 General Housekeeping / Package Updates

* remove builder arg ([214f1da](https://github.com/Open-Study-College/osc/commit/214f1da0bc6439a6f2e0a57f7088c51325a73c03))
* removes console.log ([726aaff](https://github.com/Open-Study-College/osc/commit/726aaff3283090912abc0a6d4b9aa0720ebbc64e))
* update fly.toml ([fb7fd01](https://github.com/Open-Study-College/osc/commit/fb7fd01b1b486fd8cb3681dc86ac08da42d1685c))
* update output build folder to public ([34fde36](https://github.com/Open-Study-College/osc/commit/34fde36abd59bc62d9867c969381b051af1e7cec))
...
* remove all buildx commands ([19846ff](https://github.com/Open-Study-College/osc/commit/19846ff5cfc215761131379509f9b4a7e9805227))
* remove unnecessary build command ([cf96d7a](https://github.com/Open-Study-College/osc/commit/cf96d7ae9522a9c1331aaa8b075151e8f5bddbf1))
* remove unnecessary test ([f993b8e](https://github.com/Open-Study-College/osc/commit/f993b8e3a72334c409e9d52f65a0d668556e9d52))
* try build without cache to or from ([33e6e6d](https://github.com/Open-Study-College/osc/commit/33e6e6d8533b827e58036f6dd86b9f926c1785e3))
...
* add Primary template and spread Primary args to other templates ([ba93b7c](https://github.com/Open-Study-College/osc/commit/ba93b7cac4ee7bace4268ed91eb2034b39cd7bed))
* change stories to based on the variant properties ([86fe3e0](https://github.com/Open-Study-College/osc/commit/86fe3e097b81c7af85a5a6bde321a7a848a88bc9))
* moved loader function above meta function for better clarity of data flow ([bbb4b1e](https://github.com/Open-Study-College/osc/commit/bbb4b1e830fa5807f1d0570b0bd1caced6910f84))
* set default positions for meta tags ([58084cc](https://github.com/Open-Study-College/osc/commit/58084cced3f6330da19fbf911e3842125d94a2c7))
* update buildCanonicalUrl to recieve canonical url from Sanity ([dc7460d](https://github.com/Open-Study-College/osc/commit/dc7460d151014c514751089340d68e8bdbc6a101))
* updates function to return all settings ([514d3b8](https://github.com/Open-Study-College/osc/commit/514d3b85ddc7ec01282df89c2d237cdca92005e7))
